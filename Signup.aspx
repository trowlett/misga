...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
	...
	<h2 style="margin: 0px 0px 0px 0px">MISGA Event Information and Sign Up<br /><span style="font-size: medium">(for 
   ...
   <asp:Panel ID="PlayerPanel" runat="server">
	...
	<asp:table ID="tblGenderPool" runat="server" style="margin-top: 10px" BorderStyle="None">
        <asp:TableRow ID="tblRowGenderPool" runat="server">
            ...
            <asp:TableCell ID="tblCellFill" runat="server" Width="60px">&nbsp;</asp:TableCell>
            <asp:TableCell ID="tblCellCarpool" runat="server" BorderColor="Silver" BorderWidth="1px" BorderStyle="Solid" Width="80px" HorizontalAlign="Right">
	   ...
	   <asp:Panel ID="SpecialRulePanel" runat="server" Direction="LeftToRight">
           ...
           <asp:Label ID="Label1" runat="server" Text="Tee Choices:  "  BackColor="#FFFFCC" 
				BorderColor="#FFFFCC" ForeColor="#660033" ToolTip="Make your Tee Choice from the items on the right. See descriptions above."></asp:Label>
           <asp:RadioButtonList ID="SRCBKL" runat="server" Visible="False" BackColor="#FFFFCC"
               BorderColor="#FFFFCC" ForeColor="#660033" RepeatLayout="Flow" RepeatDirection="Horizontal" ToolTip="MISGA Standard Tee is your choice if no selection made.">
               <asp:ListItem Selected="True" Text="STD" Value="STD"></asp:ListItem>
           </asp:RadioButtonList>
